...
const myTaskEither = TE.tryCatch(() => myTask(), E.toError)
...
result().then((res) => console.log('result1 => ', res))
...
getHelloAndAddWorld().then((res) => console.log(res))
