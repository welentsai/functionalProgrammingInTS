...
let output = identity("myString"); // let output: string, compiler 自動給定type
...
let myNumArr = getArray<number>([100, 200, 300]);  // number[], [ 100, 200, 300 ]
let myStrArr  = getArray<string>(["Hello", "World"]); // string[], [ 'Hello', 'World' ]
