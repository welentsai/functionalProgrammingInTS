...
const categories: Category[] = [{ id: '1', slug: 'a' }, { id: '2', slug: 'b' }, { id: '3', slug: 'c' }];
...
const getCategoryById: (id: string) => E.Either<Error, O.Option<Category>> = (id: string) => pipe(
    O.fromNullable(id),
...
const getCategoryBySlug: (slug: string) => E.Either<Error, O.Option<Category>> = (slug: string) => pipe(
    O.fromNullable(slug),
