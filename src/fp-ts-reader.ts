...
const f3 = (b: boolean): ((deps: Dependencies) => string) => deps => (b ? deps.i18n.true : deps.i18n.false)
...
// 用 fp-ts Reader 改寫 
const f4 = (b: boolean): R.Reader<Dependencies, string> => deps => (b ? deps.i18n.true : deps.i18n.false)
